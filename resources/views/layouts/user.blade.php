            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                            ...
                            @if (!auth()->user()->hasStore())
                                <li class="nav-item">
                                    <a href="{{ route('stores.create') }}"
                                        class="nav-link {{ request()->routeIs('stores.create') ? 'active' : '' }}">Create
                                        Store</a>
                                </li>
                            @endif
                        @endcan
                        @if (auth()->user()->hasStore())
                            <li class="nav-item">
                                <a href="{{ route('stores.show', auth()->user()->store) }}"
                                    class="nav-link {{ request()->routeIs('stores.show') ? 'active' : '' }}">My
                                    Store</a>
                            </li>
                        @endif
                    </ul>
